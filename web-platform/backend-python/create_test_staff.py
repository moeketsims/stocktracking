...
# Test staff details
EMAIL = "teststaff@potatostock.com"
PASSWORD = "TestStaff123!"
FULL_NAME = "Test Staff"
LOCATION_ID = "b0000000-0000-0000-0000-000000000003"  # Harrismith location

print(f"Creating test staff member: {EMAIL}")
