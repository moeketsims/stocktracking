...
export type AdjustmentReason = 'count_error' | 'theft' | 'found_stock' | 'damage_write_off' | 'system_correction' | 'other';
export type BatchStatus = 'available' | 'quarantine' | 'hold' | 'depleted';
